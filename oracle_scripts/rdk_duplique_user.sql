...
prompt testing connection with external authentication on /@&reference_tns_entry._oraexploit.
...
/
spool off
prompt connection with external authentication on /@&target_tns_entry._oraexploit.
whenever sqlerror EXIT SQL.SQLCODE --CONTINUE
